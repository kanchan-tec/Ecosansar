    ...
    <div id="page-content">
                        ...
                        <div class="item" data-id="1">
                            <a href="detail.html">
                                ...
                                <div class="image bg-transfer">
                                    <img src="frontend/assets/img/items/1.jpg" alt="">
                                </div>
                                <!--end image-->
                            </a>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="item" data-id="2">
                            <a href="detail.html">
                                ...
                                <!--end description-->
                                <div class="image bg-transfer">
                                    <img src="frontend/assets/img/items/2.jpg" alt="">
                                </div>
                                <!--end image-->
                            </a>
                            <div class="additional-info">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="item" data-id="15">
                            ...
                            <a href="detail.html">
                                ...
                                <!--end description-->
                                <div class="image bg-transfer">
                                    <img src="frontend/assets/img/items/3.jpg" alt="">
                                </div>
                                <!--end image-->
                            </a>
                            <div class="additional-info">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="item" data-id="3">
                            ...
                            <a href="detail.html">
                                ...
                                <!--end description-->
                                <div class="image bg-transfer">
                                    <img src="frontend/assets/img/items/4.jpg" alt="">
                                </div>
                                <!--end image-->
                            </a>
                            <div class="additional-info">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="item" data-id="4">
                            <a href="detail.html">
                                ...
                                <!--end description-->
                                <div class="image bg-transfer">
                                    <img src="frontend/assets/img/items/5.jpg" alt="">
                                </div>
                                <!--end image-->
                            </a>
                            <div class="additional-info">
                    ...
                    <div class="col-md-5 col-sm-5">
                        <div class="item" data-id="6">
                            <a href="detail.html">
                                ...
                                <!--end description-->
                                <div class="image bg-transfer">
                                    <img src="frontend/assets/img/items/6.jpg" alt="">
                                </div>
                                <!--end image-->
                            </a>
                            <div class="additional-info">
                ...
                <div class="owl-carousel" data-owl-items="6" data-owl-loop="1" data-owl-auto-width="1" data-owl-nav="1" data-owl-dots="1" data-owl-nav-container="#gallery-nav">
                    ...
                    <div class="item featured" data-id="23">
                        <a href="detail.html">
                            ...
                            <!--end description-->
                            <div class="image bg-transfer">
                                <img src="frontend/assets/img/items/11.jpg" alt="">
                            </div>
                            <!--end image-->
                        </a>
                        <div class="additional-info">
                    ...
                    <div class="item featured" data-id="8">
                        <a href="detail.html">
                            ...
                            <!--end description-->
                            <div class="image bg-transfer">
                                <img src="frontend/assets/img/items/10.jpg" alt="">
                            </div>
                            <!--end image-->
                        </a>
                        <div class="additional-info">
                    ...
                    <div class="item featured" data-id="5">
                        <a href="detail.html">
                            ...
                            <!--end description-->
                            <div class="image bg-transfer">
                                <img src="frontend/assets/img/items/28.jpg" alt="">
                            </div>
                            <!--end image-->
                        </a>
                        <div class="additional-info">
                    ...
                    <div class="item featured" data-id="7">
                        <a href="detail.html">
                            ...
                            <!--end description-->
                            <div class="image bg-transfer">
                                <img src="frontend/assets/img/items/12.jpg" alt="">
                            </div>
                            <!--end image-->
                        </a>
                        <div class="additional-info">
                    ...
                    <div class="item featured" data-id="1">
                        <a href="detail.html">
                            ...
                            <!--end description-->
                            <div class="image bg-transfer">
                                <img src="frontend/assets/img/items/16.jpg" alt="">
                            </div>
                            <!--end image-->
                        </a>
                        <div class="additional-info">
                        ...
                        <div class="testimonials center box">
                            <div class="owl-carousel" data-owl-items="1" data-owl-nav="0" data-owl-dots="1">
                                <blockquote>
                                    <div class="image">
                                        <div class="bg-transfer">
                                            <img src="frontend/assets/img/person-01.jpg" alt="">
                                        </div>
                                    </div>
                                ...
                                <blockquote>
                                    <div class="image">
                                        <div class="bg-transfer">
                                            <img src="frontend/assets/img/person-04.jpg" alt="">
                                        </div>
                                    </div>
                                    <h3>Peter Doe</h3>
                                    <h4>CEO at ArtBrands</h4>
        ...
        <section class="block">
            <div class="container">
                ...
                <div class="logos">
                    <div class="logo">
                        <a href="#"><img src="frontend/assets/img/logo-1.png" alt=""></a>
                    </div>
                    <div class="logo">
                        <a href="#"><img src="frontend/assets/img/logo-2.png" alt=""></a>
                    </div>
                    <div class="logo">
                        <a href="#"><img src="frontend/assets/img/logo-3.png" alt=""></a>
                    </div>
                    <div class="logo">
                        <a href="#"><img src="frontend/assets/img/logo-4.png" alt=""></a>
                    </div>
                    <div class="logo">
                        <a href="#"><img src="frontend/assets/img/logo-5.png" alt=""></a>
                    </div>
                </div>
                <!--/ .logos-->
            </div>
...
<script type="text/javascript" src="frontend/assets/js/markerclusterer_packed.js"></script>
<script type="text/javascript" src="frontend/assets/js/infobox.js"></script>
<script type="text/javascript" src="frontend/assets/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="frontend/assets/js/jquery.fitvids.js"></script>
<script type="text/javascript" src="frontend/assets/js/moment.js"></script>
<script type="text/javascript" src="frontend/assets/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="frontend/assets/js/icheck.min.js"></script>
<script type="text/javascript" src="frontend/assets/js/owl.carousel.min.js"></script>
<script type="text/javascript" src="frontend/assets/js/jquery.nouislider.all.min.js"></script>
